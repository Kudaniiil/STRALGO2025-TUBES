...
public class MusicSchedulerV2 {
    ...
    static void initializeData() {
        players.add(new Player("A", Arrays.asList("Gitar"), new HashSet<>(Arrays.asList(1))));
        players.add(new Player("B", Arrays.asList("Bass"), new HashSet<>(Arrays.asList(1))));
        players.add(new Player("C", Arrays.asList("Keyboard"), new HashSet<>(Arrays.asList(1))));
        players.add(new Player("D", Arrays.asList("Drum"), new HashSet<>(Arrays.asList(1))));
        players.add(new Player("E", Arrays.asList("Gitar"), new HashSet<>(Arrays.asList(2))));
        players.add(new Player("F", Arrays.asList("Bass"), new HashSet<>(Arrays.asList(2))));
        players.add(new Player("G", Arrays.asList("Keyboard"), new HashSet<>(Arrays.asList(2))));
        players.add(new Player("H", Arrays.asList("Drum"), new HashSet<>(Arrays.asList(2))));
    }
